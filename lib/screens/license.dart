...
import 'package:tranki_tv/screens/playlistScreen.dart';
import 'package:tranki_tv/screens/m3U_playlist.dart';
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center,
              ...
              children: [
                SizedBox(width: screenSize.width*0.3,
                  child: ElevatedButton(
                    ...
                    onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> M3U()));
              ...
              SizedBox(width: screenSize.width*0.3,
                child: ElevatedButton(
                    ...
                    onPressed: (){}, child:const Text('Reject', style: TextStyle(color: Colors.red),)
                    ),
              ),
